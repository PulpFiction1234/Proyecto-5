...
import { faCalendarAlt, faGear, faCircleQuestion, faDoorOpen  } from '@fortawesome/free-solid-svg-icons';
...
export default function UserPortalLayout({ children }: PortalLayoutProps) {
  const auth = useAuth();
